...
import winVoice from '../../assets/audio/necoChaosWin.mp3'
...
const necoChaos = {
  ...
  message: {
    ...
    enemyIntro:
      'Mwahaha! Only if you can dodge my chaotic torpedoes, Neco-Arc!',
    victoryQuote:
      'Mwahaha! Your tricks are worthless against true chaos',
      // eslint-disable-next-line quotes
      loseQuote:"Grr, you may have won, but next time I'll turn your victory into ashes, Neco-Arc"
  },
};
